...
(() => {
    ...
    console.log('valida preco 10 categoria difere Livre Distribuicao Sucesso', retorno);
    ...
    console.log("repositorio somente com as cadastros ok 131, 132, 133 e 138", livros);
